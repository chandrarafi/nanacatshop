    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Form tambah data barang masuk</p>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kdmasuk" name="kdmasuk" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="tglmasuk">Tanggal Masuk</label>
                                <input type="date" class="form-control" id="tglmasuk" name="tglmasuk" required value="<?= date('Y-m-d') ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="namaspl" placeholder="Pilih Supplier" readonly>
                                    <input type="hidden" id="kdspl" name="kdspl" required>
...
<script>
    $(document).ready(function() {
        ...
        // Get next ID
        function getNextKdMasuk() {
            $.ajax({
                url: '<?= site_url('admin/barangmasuk/getNextKdMasuk') ?>',
                method: 'GET',
                success: function(response) {
                    if (response.status === 'success') {
                        $('#kdmasuk').val(response.data.kdmasuk);
                    }
                }
            });
        }
        ...
        $('#form-barangmasuk').submit(function(e) {
            ...
            $.ajax({
                url: '<?= site_url('admin/barangmasuk/addBarangMasuk') ?>',
                method: 'POST',
                data: $(this).serialize(),
                success: function(response) {
                    if (response.status === 'success') {
