...
<div class="card shadow-sm">
    <div class="card-header d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center gap-2"><i class="bi bi-calendar2-month text-primary"></i>
            <h5 class="mb-0">Laporan Booking Perbulan</h5>
        </div>
...
<script>
    ...
    function loadData() {
        ...
        fetch('<?= site_url('admin/laporan/booking-perbulan/data') ?>?' + buildQuery())
    ...
    document.getElementById('btnFilter').addEventListener('click', function() {
        loadData();
        document.getElementById('btnCetak').setAttribute('href', '<?= site_url('admin/laporan/booking-perbulan/cetak') ?>?' + buildQuery());
    });
