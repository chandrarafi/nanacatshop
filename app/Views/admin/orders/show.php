                        ...
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <?php if (!empty($pelanggan)): ?>
                                    <div class="mt-1">
                                        <div class="fw-semibold"><?= esc($pelanggan['nama']) ?></div>
                                        <div class="text-muted small">ID: <?= esc($order['pelanggan_id']) ?> • <?= esc($pelanggan['nohp'] ?? '-') ?></div>
                                    </div>
                                <?php else: ?>
                                    <?= esc($order['pelanggan_id']) ?>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="col-12"><span class="text-muted">Alamat:</span> <?= esc(!empty($pelanggan['alamat']) ? $pelanggan['alamat'] : $order['shipping_address']) ?></div>
