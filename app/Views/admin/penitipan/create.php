...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="<?= site_url('admin/penitipan/store') ?>" method="post" id="form-penitipan">
                <?= csrf_field() ?>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kdpenitipan" name="kdpenitipan" value="<?= $kode_penitipan ?>" readonly>
                        </div>

                        <div class="mb-3">
                            <label for="tglmasuk" class="form-label">Tanggal Masuk</label>
                            <input type="date" class="form-control" id="tglmasuk" name="tglmasuk" value="<?= date('Y-m-d') ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="durasi" class="form-label">Durasi (Hari)</label>
                            <input type="number" class="form-control" id="durasi" name="durasi" min="1" value="1" required>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <h6 class="mb-0"><span id="total-hari">1</span> Hari</h6>
                                </div>
                                <hr>
...
<script>
    $(document).ready(function() {
        ...
        $('#form-penitipan').on('submit', function(e) {
            ...
            if (valid) {
                $.ajax({
                    url: '<?= site_url('admin/penitipan/store') ?>',
                    type: 'POST',
                    data: $(this).serialize(),
                    dataType: 'json',
                    beforeSend: function() {
